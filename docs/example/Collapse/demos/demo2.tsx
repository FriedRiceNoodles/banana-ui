...
import { Collapse } from '@banana/banana-react';
    ...
    <div>
      <Collapse title="点我">
        <div style={{ display: 'flex' }} slot="expand-icon">
          <svg t="1683252527212" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="993" width="16" height="16">
            <path
        ...
        <div style={{ display: 'flex' }} slot="collapse-icon">
          <svg t="1683252725530" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1193" width="16" height="16">
            <path
